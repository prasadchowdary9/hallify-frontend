...
import { getVenue, fetchVenues, refetchAndGetVenue } from "@/lib/data";
...
const Booking = () => {
  ...
  useEffect(() => {
    const fetchVenueIfMissing = async () => {
      if (venueId && !venue) {
        const refetched = await refetchAndGetVenue(venueId);
        if (refetched) {
          setVenue(refetched);
        } else {
          navigate("/venues"); // fallback if still not found
        }
      }
    };

    fetchVenueIfMissing();
  }, [venueId, venue, navigate]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (step === 1) {
      ...
      const VenueDetails = getVenue(venueId);
      console.log("venue", VenueDetails);
      const bookingData = {
        ...formData,
        venue: {
          id: VenueDetails.id, // Pass venue ID
          name: VenueDetails.name, // Pass venue name
          price: VenueDetails.price, // If you need venue price, you can add it here
        },
      };
      ...
      <div className="min-h-screen pt-24 px-6">
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <p className="mb-6">
              Please select a venue to continue with your booking.
            </p>
        ...
        <div className="flex justify-center mb-12">
          <div className="flex items-center w-full max-w-3xl">
            <div className="flex-1 flex flex-col items-center">
              ...
              <span
                className={`text-sm ${step === 1 ? "font-semibold text-blue-500" : "text-gray-600"}`}
              >
                Event Details
              </span>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <span
                className={`text-sm ${step === 2 ? "font-semibold text-blue-500" : "text-gray-600"}`}
              >
                Personal Info
              </span>
            </div>
            <div
              className={`flex-1 h-1 ${step >= 3 ? "bg-blue-500" : "bg-gray-200"}`}
            />
            <div className="flex-1 flex flex-col items-center">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${
              ...
              <span
                className={`text-sm ${step === 3 ? "font-semibold text-blue-500" : "text-gray-600"}`}
              >
                Confirmation
              </span>
            </div>
                    ...
                    <div className="mb-6">
                      <div className="flex items-start space-x-3">
                        ...
                        <Label htmlFor="terms" className="text-sm">
                          ...
                          venue's availability and approval.
                        </Label>
                      </div>
                    </div>
            ...
            <div className="sticky top-24">
              ...
              <div className="mt-6 bg-blue-50 rounded-xl p-5 border border-blue-100">
                ...
                <p className="text-sm text-blue-700 mb-4">
                  Our venue specialists are ready to help you plan your event.
                </p>
